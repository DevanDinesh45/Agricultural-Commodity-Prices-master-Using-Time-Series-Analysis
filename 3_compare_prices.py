# -*- coding: utf-8 -*-
"""3.Compare_prices.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/12vae2xrAZtGgHaJgdHiPXocb0rofM9St
"""
...
df=pd.read_csv("/content/drive/MyDrive/Statistical-Time-Series-Analysis-on-Agricultural-Commodity-Prices-master/deseasonalize_data.csv")
df["date"]=pd.to_datetime(df["date"])
comm = df['Commodity'].unique().tolist()

df_msp = pd.read_csv("/content/drive/MyDrive/Statistical-Time-Series-Analysis-on-Agricultural-Commodity-Prices-master/CMO_MSP_Mandi_filtered.csv")
